...
/**
 * SoloRed - Combined Solo + SoloTest (Inertial Auto-Aim to RED Goal)
 * 
 * === MODES ===
 * - MANUAL: D-Pad turret control (same as Solo)
 * - AUTO_AIM: Inertial navigation auto-aim to RED basket (140, 140)
 * 
 * === CONTROLS ===
...
public class SoloRed extends CommandOpMode {
    ...
    private static final int TARGET_TAG_ID = Vision.RED_GOAL_TAG_ID;  // 24
    ...
    public void initialize() {
        ...
        telemetry.addLine("Target: RED basket (140, 140)");
        telemetry.update();
    }
    ...
    private void updateTelemetry() {
        ...
        if (controlMode == ControlMode.AUTO_AIM) {
            ...
            telemetry.addData("Target", "RED (140, 140)");
        }
